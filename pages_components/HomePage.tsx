    ...
    onUpdate
        ...
        return (
            <section className="bg-white text-slate-900 -mt-20 md:mt-0 relative z-0 pt-20 md:pt-0 overflow-hidden">
                {/* Subtle Background Elements to blend with Amber Header */}
                {/* Ultra-Modern Powerful SVG Background */}
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    ...
                    {/* Dynamic Power Blobs */}
                    <div className="absolute -top-[30%] -right-[15%] w-[900px] h-[900px] bg-gradient-radial from-emerald-100/40 via-emerald-50/10 to-transparent blur-[80px] mix-blend-multiply"></div>
                    ...
                    {/* Geometric Accents */}
                    <svg className="absolute -right-20 top-20 w-96 h-96 text-emerald-500/10 animate-pulse-slow" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="w-full md:px-6 pt-8 pb-12 md:pt-16 md:pb-20 flex flex-col md:flex-row items-center gap-10 relative z-10"> {/* Removed max-w-7xl mx-auto */}
                    ...
                    <div className="flex-1 text-center md:text-left space-y-5 md:space-y-6 px-4 md:px-0">
                        ...
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-black leading-tight text-slate-900">
                            <EditableText
                                ...
                                tag="span"
                            />{' '}
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-green-600 block sm:inline">
                                <EditableText
                        ...
                        <div className="flex flex-row items-center justify-center md:justify-start gap-3 pt-2 w-full max-w-md mx-auto md:mx-0">
                            <button
                                ...
                                className="group relative flex-1 h-14 inline-flex items-center justify-center gap-2 px-2 md:px-6 rounded-2xl bg-emerald-500 text-slate-900 font-extrabold text-[12px] sm:text-sm tracking-wide shadow-xl shadow-emerald-500/20 hover:bg-emerald-400 hover:scale-[1.02] active:scale-95 transition-all duration-300 overflow-hidden whitespace-nowrap"
                    ...
                    <div className="hidden xl:flex flex-1 items-center justify-center">
                        <div className="relative w-full max-w-md group">
                            <div className="absolute -inset-1 bg-gradient-to-r from-emerald-300 to-green-400 rounded-[2.5rem] blur opacity-20 group-hover:opacity-40 transition duration-1000 group-hover:duration-200" />
    ...
    return (
        <div className="bg-slate-50 min-h-screen">
            ...
            */}
            <div
                ref={mobileHeaderRef}
                className="md:hidden fixed top-0 left-0 right-0 z-30 bg-gradient-to-b from-emerald-400 to-green-600 text-slate-900 shadow-xl rounded-b-[2.5rem] overflow-hidden"
            >
                {/* Decorative Blobs */}
                ...
                <div className="w-full px-5 pb-6" style={{ paddingTop: `calc(env(safe-area-inset-top) + 1rem)` }}>
                    ...
                    <div className="flex items-center gap-4">
                        <a href="/profile" className="relative shrink-0">
                            ...
                            <div className="absolute bottom-0 right-0 w-3.5 h-3.5 bg-green-500 border-2 border-emerald-400 rounded-full"></div>
                        </a>

                        <button
                            onClick={() => setIsMobileSearchOpen(true)}
                            className="flex-grow h-11 bg-white/40 backdrop-blur-md border border-white/50 rounded-full flex items-center px-4 text-slate-900 shadow-sm group active:scale-95 transition-all"
                        >
                            <MagnifyingGlassIcon className="w-5 h-5 mr-3 text-slate-800" />
                            <span className="text-sm font-medium text-slate-800">Tap to search...</span>
                        </button>

                        <div className="relative">
                            <NotificationBell
                                navigate={navigate}
                                iconClassName="w-6 h-6 text-slate-900"
                                buttonClassName="shrink-0 w-11 h-11 flex items-center justify-center bg-white/40 border border-white/50 rounded-full hover:bg-white/50 transition-all backdrop-blur-md active:scale-95 shadow-sm"
                            />
                        </div>
                    </div>
                    ...
                    <div className="mt-5 flex items-center justify-between">
                        <div>
                            <p className="text-emerald-950/80 text-xs font-bold uppercase tracking-wider mb-0.5">Welcome Back,</p>
                            <h1 className="text-2xl font-black text-slate-900 truncate max-w-[200px] drop-shadow-sm">{user?.name ? user.name.split(' ')[0] : 'Guest'}</h1>
                        </div>

                        {/* Location Pill - Right Aligned (Below Bell Area) */}
                        <div className="flex flex-col items-end">
                            <div className="flex items-center gap-1.5 bg-white/40 backdrop-blur-md border border-white/50 px-3 py-1.5 rounded-full text-slate-900 text-xs font-bold shadow-sm hover:bg-white/50 transition-colors cursor-default">
                                <MapPinIcon className="w-3.5 h-3.5 text-slate-800" />
