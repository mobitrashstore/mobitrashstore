...
const NotificationBell: React.FC<NotificationBellProps> = ({ 
    ...
    buttonClassName = "relative p-2 text-gray-500 hover:text-[#00bfff] transition-colors rounded-full hover:bg-gray-100/50 focus:outline-none"
}) => {
                    ...
                    {createPortal(
                        ...
                        <div className="md:hidden fixed inset-0 z-[60] flex items-start justify-center pt-24 px-4 pointer-events-none">
                             ...
                             <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl border border-white/20 overflow-hidden pointer-events-auto animate-slide-in-down relative z-10 flex flex-col max-h-[60vh]">
                                 {/* Header - Styled to match the Main App Header (Green Gradient) */}
                                 <div className="p-4 border-b border-white/10 bg-gradient-to-r from-emerald-400 to-green-600 flex justify-between items-center sticky top-0 z-20 shadow-md">
