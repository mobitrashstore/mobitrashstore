...
const HowItWorks: React.FC = () => {
    const steps = [
        {
            icon: <CashIcon className="w-10 h-10 text-[#059669]" />,
        ...
        {
            icon: <TruckIcon className="w-10 h-10 text-[#059669]" />,
        ...
        {
            icon: <ShieldCheckIcon className="w-10 h-10 text-[#059669]" />,
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {steps.map((step, index) => (
                        <div key={index} className="bg-white border border-gray-200 p-8 rounded-lg shadow-lg text-center transform hover:-translate-y-2 transition-transform duration-300">
                            <div className="flex items-center justify-center w-20 h-20 mx-auto bg-[#059669]/10 rounded-full">
                                {step.icon}
                            </div>
