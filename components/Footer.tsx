                        ...
                        <div className="md:col-span-8 grid grid-cols-3 gap-4 lg:gap-8">
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 text-sm text-slate-400">
                                    ...
                                    <li><a href="/trust" onClick={(e) => handleNav(e, '/trust')} className="hover:text-emerald-400 transition-colors flex items-center gap-1.5 font-bold" title="Our Commitment to Trust & Safety"><ShieldCheckIcon className="w-3.5 h-3.5" /> Trust & Safety</a></li>
