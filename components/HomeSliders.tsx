                ...
                <div className="flex-grow overflow-hidden relative mask-linear-fade">
                    <div className="flex gap-8 items-center animate-marquee w-max hover:pause">
                        {desktopCategories.map((cat, index) => (
                            ...
                            >
                                <div className="w-14 h-14 rounded-full bg-gray-50 border border-gray-100 shadow-sm flex items-center justify-center p-2 group-hover:border-[#059669] group-hover:bg-white transition-all overflow-hidden">
                                ...
                                <span className="text-xs font-bold text-gray-600 group-hover:text-[#059669] text-center whitespace-nowrap">{cat.name}</span>
                            </button>
                        ))}
                    </div>
                </div>
            ...
            <div className="md:hidden overflow-hidden w-full bg-slate-50 py-3 relative">
                <div className="flex items-center gap-6 animate-marquee w-max">
                    {mobileCategories.map((cat, index) => (
                        ...
                        >
                            <div className="w-16 h-16 rounded-2xl bg-white border border-gray-100 shadow-sm flex items-center justify-center p-3 group-hover:border-[#059669] transition-all overflow-hidden">
