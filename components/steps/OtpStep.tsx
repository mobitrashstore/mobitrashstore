                    ...
                    {view === 'details' ? (
                        <form onSubmit={handleSendRequest} className="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="fullName" id="fullName" value={details.fullName} onChange={handleDetailsChange} placeholder="Enter full name here." required className="mt-1 block w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-[#059669] focus:border-[#059669]" />
                            </div>
                            <div>
                                <label htmlFor="address" className="block text-sm font-medium text-gray-700">Address</label>
                                <input type="text" name="address" id="address" value={details.address} onChange={handleDetailsChange} placeholder="Enter address here." required className="mt-1 block w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-[#059669] focus:border-[#059669]" />
                            </div>
                            <div>
                                <label htmlFor="phone" className="block text-sm font-medium text-gray-700">Phone Number</label>
                                <input type="tel" name="phone" id="phone" value={details.phone} onChange={handleDetailsChange} placeholder="Enter phone number here." required className="mt-1 block w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-[#059669] focus:border-[#059669]" />
                            </div>
                            <div>
                                <label htmlFor="email" className="block text-sm font-medium text-gray-700">Email</label>
                                <input type="email" name="email" id="email" value={details.email} onChange={handleDetailsChange} placeholder="Enter email address here." required className="mt-1 block w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-[#059669] focus:border-[#059669]" />
                            </div>
                            {error && <p className="text-xs text-red-600">{error}</p>}
                            <button type="submit" disabled={!isDetailsFormValid || loading} className="w-full bg-[#059669] text-black font-bold py-3 px-4 rounded-md hover:bg-[#e64a19] transition-colors disabled:bg-gray-300 disabled:cursor-wait">
                        ...
                        <form onSubmit={handleVerifyOtp} className="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="otp" id="otp" value={otpInput} onChange={(e) => setOtpInput(e.target.value)} placeholder="Enter OTP" required maxLength={4} className="mt-1 block w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-[#059669] focus:border-[#059669]" />
                            </div>
                            {error && <p className="text-xs text-red-600">{error}</p>}
                            
                            <div className="flex flex-col gap-3">
                                <button type="submit" disabled={loading} className="w-full bg-[#059669] text-black font-bold py-3 px-4 rounded-md hover:bg-[#e64a19] transition-colors disabled:bg-gray-300 disabled:cursor-wait">
                                ...
                                <button 
                                    ...
                                    className="w-full text-sm font-bold text-[#059669] disabled:text-gray-400 hover:underline transition-colors"
                                >
