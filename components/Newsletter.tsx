            ...
            <div className="relative overflow-hidden rounded-3xl bg-slate-900 border border-slate-800 shadow-2xl">
                ...
                <div className="relative z-10 px-6 py-10 md:p-16 text-center max-w-2xl mx-auto">
                    ...
                    <h2 className="text-2xl md:text-3xl font-black text-white mb-4 tracking-tight">
                        Join the <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-green-500">Eco-Movement.</span>
                    </h2>
                    ...
                    <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3">
                        <input
                            ...
                            required
                            className="flex-1 bg-slate-800/50 border border-slate-700 text-white placeholder-slate-500 rounded-xl px-5 py-3.5 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 transition-all"
                        />
                        <button
                            type="submit"
                            disabled={status === 'submitting' || status === 'success'}
                            className={`px-8 py-3.5 rounded-xl font-bold bg-emerald-500 text-slate-900 shadow-lg shadow-emerald-500/20 hover:bg-emerald-400 focus:ring-4 focus:ring-emerald-500/30 transition-all ${status === 'success' ? 'bg-green-500 cursor-default' : ''
                                }`}
                        >
